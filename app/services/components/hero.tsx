      ...
      <div className="container mx-auto flex flex-col items-center px-5 py-24 md:flex-row">
        ...
        <div className="flex flex-col items-center text-center md:w-1/2 md:items-start md:pl-16 md:text-left lg:grow lg:pl-24">
          ...
          <div className="flex text-gray-300 md:flex-col lg:flex-row">
            <button className="inline-flex items-center rounded-lg bg-gray-800 px-5 py-3 hover:bg-gray-700 hover:text-white focus:outline-none">
              <svg
            ...
            <button className="ml-4 mt-0 inline-flex items-center rounded-lg bg-gray-800 px-5 py-3 hover:bg-gray-700 hover:text-white focus:outline-none md:ml-0 md:mt-4 lg:ml-4 lg:mt-0">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="size-6"
