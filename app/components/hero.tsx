...
const Hero = () => {
  return (
    <>
      <section className="h-full bg-gray-900  pt-0 lg:pl-8 lg:pt-20">
        <div className="m-5 overflow-hidden rounded-2xl bg-slate-800 py-10 lg:m-0 lg:rounded-l-2xl xl:py-8  2xl:py-16 ">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-12">
              <div className="w-full lg:col-span-6 xl:col-span-5 xl:-mx-0 2xl:-mx-5">
                ...
                <h1 className="py-8 text-center text-5xl font-bold leading-[70px] text-gray-100 lg:text-left">
                  🎉 Ljeto je stiglo 3D printaj za more i sunce!
                </h1>
                <p className=" text-center text-lg text-white lg:text-left">
                  Iskoristi ljetne popuste i otkrij unikatne dodatke za plažu,
                  putovanja i avanture na otvorenom. Personaliziraj svoje ljeto
                  već danas!
                </p>
